...
vim.keymap.set("n", "<leader>gPro", function() vim.cmd("Git pull --rebase origin " .. branch_name()) end)
vim.keymap.set("n", "<leader>gPru", function() vim.cmd("Git pull --rebase upstream " .. branch_name()) end)
